...
def main():
    ...
    clf = MLPClassifier(activation='tanh', alpha=0.001, hidden_layer_sizes=(32, 64),
    ...
    csvFile = open("MLPy830D_proba.csv", 'a', newline='')
    writer = csv.writer(csvFile, dialect='excel')
    writer.writerow(probass_y)
    csvFile.close()

    csvFile = open("MLPtest830D_index.csv", 'a', newline='')
    writer = csv.writer(csvFile, dialect='excel')
