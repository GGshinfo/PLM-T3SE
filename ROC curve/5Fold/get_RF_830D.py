...
def main():
    ...
    param_grid1 = {"n_estimators": n_estimators, "max_depth": max_depth, 'min_samples_split': min_samples_split,
                   'min_samples_leaf': min_samples_leaf, 'max_features': max_features}
    kf = KFold(n_splits=5, shuffle=True, random_state=123)
    gs = GridSearchCV(estimator=RandomForestClassifier(random_state=10), param_grid=param_grid1,
